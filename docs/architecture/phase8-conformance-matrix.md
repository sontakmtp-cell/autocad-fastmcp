...
| Gateway sealed storage/binding | Cross-stack and real-compiler integration tests | Green | Public root/patch/rebase prepare derives trusted snapshot refs; immutable lineage, conflicts, exact materialized refs, intent/consent and pack-specific capability evidence are sealed |
